...
* **Our Solution (Correction #4 & #1):**
  ...
  * **80/20 Physics-ML Hybrid Blend:** Each individual hazard probability is computed as a weighted ensemble: $80\%$ driven by verifiable deterministic physics rules (e.g. Teale MSE, Eaton FG) and $20\%$ driven by the multi-class LightGBM predictions. This guarantees physics-based guardrails while leveraging ML for subtle multi-variate pattern recognition.
